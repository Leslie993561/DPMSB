...
export async function GET() {
  ...
  for (const c of colaboradores) {
    ...
    sheet.addRow({
      ...
      tituloEleitorEmissao: c.tituloEleitorEmissao ?? "",
      cnhCategoria: c.cnhCategoria ?? "",
      cnhValidade: c.cnhValidade ?? "",
      cnhEmissao: c.cnhEmissao ?? "",
      reservistaSerie: c.reservistaSerie ?? "",
      tamanhoCamisa: c.tamanhoCamisa ?? "",
      tamanhoCalca: c.tamanhoCalca ?? "",
      tamanhoSapato: c.tamanhoSapato ?? "",
      email: c.email ?? "",
      cargo: c.cargo ?? "",
      ...
      odontologicoValor: c.odontologicoValor ?? "",
      auxilioEducacaoValor: c.auxilioEducacaoValor ?? "",
