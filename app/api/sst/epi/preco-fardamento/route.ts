...
import { definirPrecoFardamento } from "@/lib/sst/epi";
...
/** RH edita o valor unitário de um item de fardamento em Custo e Valores. Admin-only. */
export async function PUT(request: Request) {
  ...
  try {
    await definirPrecoFardamento(parsed.data.tipo, parsed.data.valor);
  } catch (erro) {
