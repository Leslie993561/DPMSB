...
export async function GET(request: Request) {
  ...
  sheet.columns = [
    ...
    { header: "Auxílio educação", key: "auxilioEducacao", width: 16 },
    ...
    { header: "TotalPass", key: "totalPass", width: 12 },
    { header: "Assistência médica", key: "assistenciaMedica", width: 18 },
    { header: "Sólides (Saúde)", key: "solidesSaude", width: 16 },
    ...
    // Vem do Rateio de Benefícios: aniversário do mês e o que foi informado na
    // planilha de rateio. Já aparecia na tela do Relatório detalhado, mas
    // faltava aqui — a exportação tem de trazer as mesmas colunas do rateio.
  ...
  for (const l of filtradas) {
    sheet.addRow({
      ...
      auxilioEducacao: l.auxilioEducacao || "",
      vm: l.vm ?? "",
      odontologico: l.odontologico ?? "",
      salarioFamilia: l.salarioFamilia,
      solides: l.solides ?? "",
      solidesSaude: l.solidesSaude ?? "",
      flash: l.flash ?? "",
      totalPass: l.totalPass ?? "",
      assistenciaMedica: l.assistenciaMedica ?? "",
