...
const ROTULOS: Record<CampoColaborador, string> = {
  ...
  valorTransporte: "Valor do transporte (VT ou VM)",
  rateioD365: "Rateio D365 (ADM/PRO)",
  periculosidadePercentual: "Periculosidade (%)",
  insalubridadePercentual: "Insalubridade (%)",
  adicionalFixo: "Adicional fixo (R$)",
  adicionalFixoDescricao: "Adicional fixo — descrição",
  ...
  tituloEleitorZona: "Título — zona",
  tituloEleitorSecao: "Título — seção",
  tituloEleitorEmissao: "Título — emissão",
  cnhCategoria: "CNH — categoria",
  cnhValidade: "CNH — validade",
  cnhEmissao: "CNH — emissão",
  reservistaSerie: "Reservista — série",
